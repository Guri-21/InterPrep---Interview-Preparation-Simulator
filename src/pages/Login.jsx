  ...
  return (
    <AuthFrame>
      <motion.div
        ...
        className="w-full max-w-[420px] glass-strong rounded-2xl p-7"
      >
        <div className="flex items-center justify-between mb-6">
          <Logo size={26} />
          <span className="text-[11.5px] text-ink-400">Sign in</span>
        </div>
        ...
        <p className="mt-1 text-[13.5px] text-ink-300">
          Sign in to access your session history, analytics, and the Library.
        </p>
        ...
        <div className="mt-6 text-[12.5px] text-ink-300 inline-flex items-center gap-1.5">
          New to InterPrep?
          <Link to="/signup" className="text-brand-300 hover:text-brand-200 inline-flex items-center gap-1">
